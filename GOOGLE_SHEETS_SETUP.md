...
**Note:** The script includes CORS support (required for web deployment). If you're updating from an older version, see [CORS_FIX_GUIDE.md](./CORS_FIX_GUIDE.md).
...
### Getting CORS Error on Web? ⚠️

If you see "Access to XMLHttpRequest blocked by CORS policy" when using the web version:

**Solution:** Your script needs CORS headers!
1. See the complete fix guide: [CORS_FIX_GUIDE.md](./CORS_FIX_GUIDE.md)
2. Short version: Update your script with the latest code from `google-apps-script-example.js`
